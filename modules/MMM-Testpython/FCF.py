...
ret, frame = cap.read()
cv2.imwrite('/home/pi/testMirror/modules/MMM-Testpython/CognitiveFace/CognitiveFace.jpg', frame)
...
image_path = os.path.join('/home/pi/testMirror/modules/MMM-Testpython/CognitiveFace/CognitiveFace.jpg')
