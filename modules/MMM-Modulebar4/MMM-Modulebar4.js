...
var Modulebar4;
Module.register("MMM-Modulebar4",{
				...
				if (modules[i].name === data.module) {
					...
					if (idnr[1] == data.idnum || data.idnum == null) {
						...
						if (modules[i].hidden) {
							...
							if(num==1){
								Modulebar4.sendNotification('PLAYLISTCHANGE',"YCcE9oGkOw8_롤");			
									} 
							else	if(num==2){
										Modulebar4.sendNotification('PLAYLISTCHANGE',"ScSn235gQx0_뮤직비디오");			
											} 
							else	if(num==3){
								Modulebar4.sendNotification('PLAYLISTCHANGE',"KUiouwhozkQ_영화");			
									} 
							else	if(num==4){
								Modulebar4.sendNotification('PLAYLISTCHANGE',"L0oei9OH7Yo_뉴스");			
									}
							else	if(num==5){
								Modulebar4.sendNotification('PLAYLISTCHANGE',"Bxg1CqqkzE0_스포츠");			
									}
							else	if(num==6){
								Modulebar4.sendNotification('PLAYLISTCHANGE',"egyB02dbJKE_먹방");			
									}
							else	if(num==7){
								Modulebar4.sendNotification('PLAYLISTCHANGE',"Vw39vVf2HCI_해외여행");			
									}
							else	if(num==8){
								Modulebar4.sendNotification('PLAYLISTCHANGE',"MFWtM11WJn0_몰카");			
									}
